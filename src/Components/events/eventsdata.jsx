...
export const eventsdata = [

  {
    ...
    description: '',
    img: [],
    topicName: ['',  'Cyber Security', 'Data Science', 'Deep Learning', 'Ethical Hacking',  'Robotics', 'Web Development'],
    img1: [[workshop19feb_1, workshop19feb_ai_2], [cyber_security, cyber_security], [data_science, data_science], [deep_learning, deep_learning], [ethical_hacking, ethical_hacking], [robotics, robotics], [web_development, web_development], [workshop19mar_1, workshop19mar_2]],
