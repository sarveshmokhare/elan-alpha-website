...
import workshops1 from "../../assets/events/workshop_1.jfif";
import workshops2 from "../../assets/events/workshop_2.jpg";
...
export const eventsdata=[
  ...
  {name:'Workshops',
    ...
    examples: [{name:'Ethical hacking and cyber security',
    description:'The workshop involved the fundamentals of cyber security, such as testing the system against all possible security breaches and solving any vulnerabilities in the system before any malicious attack ever happens.'},
    {name:'Facial and emotional recognition with deep learning',
    description:'Going deeper into facial recognition along with emotional recognition.'},
    {name:'Introduction to computer- aided engineering',
    description:'In a world where everything is online, this workshop has helped to learn the broad usage of computer software to aid in engineering analysis tasks.'},
    {name:'Website Design development workshop',
