...
import vintrus from "../assets/2023 Sponsors/Vintrus_Logo-01 (1).svg";
import canaraBank from "../assets/2023 Sponsors/CANBANK_becu5t.png";
...
import noticeBoard from "../assets/2023 Sponsors/NoticeBard Logo NEW.png";
import telenganaToday from "../assets/2023 Sponsors/TT Masthead logo.jpg";
import youthIncorporated from "../assets/2023 Sponsors/yi logo white.jpeg.jpg";
import fashionHerald from "../assets/2023 Sponsors/FASHION HERALD LOGO white1.png";
...
const Sponsor2022 = [
  ...
  },
  {
    Name: "WOW Momo",
    Description:
      "Wow Momos Franchise Food is an Indian chain of fast-food restaurants specializing in momos, dumplings, the delicacies of Tibet and Nepal, headquartered in Kolkata, West Bengal, India.",
    Website: "https://www.wowmomosfranchise.com/",
    Instagram: "",
    Image: wowmomo,
    Role: "Snack Partner",
  },
  ...
  },
  {
    Name: "GrabON",
    Description:
      "Want to save some cash without sacrificing your shopping habits? Look no further than GrabOn!With GrabOn, you can easily find the best coupons and deals for all your favourite online stores. Just a few clicks and Save On Everything!",
  ...
  },
  {
    ...
    Description:"Online face-to-face mock interviews with experts help you train & prepare for job interviews in a no pressure, stress-free environment simulating a real job interview. Stay ahead of the competition with expert mentoring & feedback!" ,
    Website: "https://www.interviewbuddy.in",
    Instagram: "",
    Image: interviewBuddy,
    Role: "Interview Partner",
  },
  {
    Name: "Banna Aerosols",
    Description:"Imagine a world where a single spray solved all your DIY problems. One spray drying harder and faster than anything you have ever used. Superior coverage on wood, masonry, plaster and rubber surfaces. The best colours on the planet assured. A superior UV protection along with Mold and mildew resistance." ,
    Website: "http://bannasprays.com/",
    Instagram: "",
    Image: banna,
    Role: "Spray Paint Partner",
  },
  {
    Name: "Le Meredien",
    Description:"" ,
  ...
  {
    Name: "Musee musicals",
    Description:"Established in 1842, Musee Musical has always been a name to reckon with in the field of Western Musical Instruments and Music education in southern India.Musee Musical has evolved into a one-stop shop for the music connoisseurs. It has supported the needs of teachers, students, musicians equally.Musee Musical has always been a trusted partner and has brought the best brands from across the world, in music all under one roof and has never compromised on quality." ,
    Website: "https://museemusical.in/",
    Instagram: "",
    Image: musee,
  ...
  // media Sponsors
  {
    Name: "Blog Adda",
    Description:"" ,
    Website: "https://blog.blogadda.com/",
    Instagram: "",
    Image: blogAdda,
    Role: "Blogging Partner",
  },
  {
    Name: "Knowafest",
    Description:"" ,
    Website: "https://www.knowafest.com/explore/events",
    Instagram: "",
    Image: knowFest,
  ...
  },
  {
    Name: "ETV",
    Description:"" ,
    Website: "https://www.bing.com/ck/a?!&&p=2bbc940f7f1cc3e2JmltdHM9MTY3NjQxOTIwMCZpZ3VpZD0zODllZWM5Zi1jNTI4LTYyZWItMzZjZC1mZGJkYzQ5NzYzMWImaW5zaWQ9NTIzNw&ptn=3&hsh=3&fclid=389eec9f-c528-62eb-36cd-fdbdc497631b&psq=ETV&u=a1aHR0cHM6Ly93d3cuZXR2LmNvLmluLw&ntb=1",
    Instagram: "",
    Image: etv,
    Role: "Brodacasting Partner",
  },
  {
    Name: "Eenadu",
    Description:"" ,
  ...
  },
  {
    ...
    Likedin:
      "https://www.google.com/url?sa=t&source=web&rct=j&url=https://in.linkedin.com/company/noticebard/&ved=2ahUKEwjRpvOa7-H2AhXtTGwGHc4ID4UQjjh6BAgPEAE&usg=AOvVaw2x03MfrWsLW4spoD72AFzt",
    Image: noticeBoard,
    Role: "Media Partner",
  },
  {
    Name: "Telenagan Today",
    Description:
      " ",
    Website: "https://telanganatoday.com/",
    Image: telenganaToday,
    Role: "Media Partner",
  },
  {
  ...
  },
  {
    ...
    Instagram:
      "https://www.google.com/url?sa=t&source=web&rct=j&url=https://www.instagram.com/fashion.herald/%3Fhl%3Den&ved=2ahUKEwjOzMnR7-H2AhXAR2wGHb9nCIYQjjh6BAhCEAE&usg=AOvVaw19QQOPygjnr1HSgcc3hGhh",
    Image: fashionHerald,
    Role: "Fashion Magazine Partner",
  },
  {
    Name: "Groove Nexus",
    Description:
...
const Sponsor2021 = [
  ...
  //   Website: "",
  //   Instagram:
  //     "https://www.google.com/url?sa=t&source=web&rct=j&url=https://www.instagram.com/blurindia/%3Fhl%3Den&ved=2ahUKEwjmqaPK7uH2AhVOTGwGHV3bDYUQjjh6BAgyEAE&usg=AOvVaw2ySg9P0jzi1gbgaMAM1VVp",
  //   Image: Blur,
  //   Role: "Beauty Partner",
  // },
  // {
  ...
  //   Role: "Beauty partner",
  // },
  // { Name: "Alumni", Description: "", Website: "", Image: IITHAlumni, Role: "" },
  // {
  //   Name: "Indian Oil",
  //   Description:
  ...
  //   Instagram:
  //     "https://www.google.com/url?sa=t&source=web&rct=j&url=https://www.instagram.com/indinoir.store/%3Fhl%3Den&ved=2ahUKEwjp1a6l7uH2AhUQRWwGHXh9CoUQjjh6BAgKEAE&usg=AOvVaw3GK9doOLlr8zn86BArH14u",
  //   Image: IndiNoir,
  //   Role: "Fragrance Partner",
  // },
  // { Name: "", Description: "", Website: "", Image: Intern360, Role: "" },
  // {
  //   Name: "KLA",
  //   Description:
  ...
  //   Name: "",
  //   Description:
  //     "QwertyThoughts is a multilingual social book reading, discovery & self-publishing platform. Books here work like virtual reading rooms.Connect with like-minded readers, discuss inside a book while reading it together, discover books based on content",
  //   Website: "https://www.qwertythoughts.com/",
  //   Instagram: "https://www.instagram.com/qwertythoughts/",
  //   Facebook: "https://www.facebook.com/qwertythoughts/",
  //   Twitter: "https://twitter.com/QwertyThoughts9",
  //   Likedin: "https://in.linkedin.com/company/qwerty-thoughts",

  //   Image: QwertyThoughts,
  ...
  //   Role: "Mentor Partner",
  // },
  // { Name: "", Description: "", Website: "", Image: Vijaya, Role: "" },
  // {
  //   Name: "",
  //   Description:
  ...
  //   Likedin: "https://www.linkedin.com/company/xcubelabs/?originalSubdomain=in",
  //   Image: Xcube,
