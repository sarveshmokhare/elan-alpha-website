...
export const techydata = [
  ...
  },
  {
    ...
    img: enig,
    details:
      "Elan & ηvision 2023, IIT Hyderabad proudly presents its code event \"Enigma\".It's time to show your knowledge about cryptography and win some awesome prizes.Get ready cryptographers to show off your expertise during ELAN & ηvision 2023.",
    format: [''],
    ...
    timeline: {
      regstart: '11th Jan 2023',
      regend: '16th Jan 2023',
      event: '18th Feb 2023'
    },
    judging: ['Team that decodes first is the winner.'],
  ...
  {
    name:"Nahoosh Jilhewar",
    contact: 8766560094
  }],
    timeline: {
      regstart: '13th Jan 2023',
      regend: '16th Feb 2023',
      event: '17-19 Feb 2023'
    },
  },
  {
    name: "Proquest",
    ...
    img: pro,
    details:
      "Elan & ηvision 2023, IIT Hyderabad proudly presents its CP event \"Proquest\". Proquest is a CP(Competitive Programming) competition composed of a single level, for participants of all levels.It is an on the spot online coding competition to show your coding skills during ELAN & ηvision 2023.",
    format: [''],
    rules: ['This event will be held in a single round. It will be hosted on Hackerrank/Codeforces. This is a 3 hour round. The top 2 participants will be declared as winner and runner up in this round. This event starts on 19/02/2023 and lasts for 3 hours. Winners will be announced 1 day after the event ends.', 'This is an individual event. No teams are allowed.', 'Any form of plagiarism would immediately lead to disqualification.', 'The organizers reserve the right to make any change to the event whenever deemed necessary.', 'All decisions made by the judges will be final and binding.', 'Contest will happen in hackerrank.', 'Link for the contest:'],
    timeline: {
      regstart: '12th Jan 2023',
      regend: '16th Feb 2023',
      event: '19th Feb, 2023'
    },
  ...
  },
  {
    ...
    judging: ['Code Quality & Design', 'Presentation', 'UI / UX', 'Technical Difficulty', ' Reliability', ' Features', 'Completeness & Integration'],
    prizes: ['The top three teams will receive prizes worth Rs. 12,000.', 'The prize money will be awarded via NEFT and processed within 30 working days.', 'The winners will be notified via email sent from elan@iith.ac.in.', '  E-certificate of Participants will be given to all the participants who have made a valid submission within the deadline.', 'E - certificate of Excellence will be given to the top 3 teams.'],
    contact: [{
      name: 'Priyesh Jain',
      contact: 7987497614
    },
  ...
  },
  {
    ...
    img: mdd,
    details:
      "Elan & ηvision 2023, IIT Hyderabad is organizing it’s Machine learning and Data Analytics event \"Machina Doctrina’s\".This contest focuses on Machine Learning, Understanding and Coding Skills of an individual/ group.Participate in the contest to show off your expertise in ML during ELAN & ηvision 2023.",
    format: [''],
    rules: ['This is an online hackathon to be held on from 17/02/2023 and is a single stage event. This event lasts for 12 hours.Winners will be announced 1 day after the event ends.', 'Participants are required to submit a Python notebook that was used to train and fine - tune the model using the given dataset.', 'Participants are also required to submit a csv file containing the predictions which will be tested against a private test dataset.', 'Participants can be an individual or a team of 2.','Codes will be subjected to a plagiarism check.Submissions found to contain plagiarism will be disqualified.'],
    timeline: {
      regstart: '14th Jan 2023',
      regend: '16th Feb 2023',
      event: '17th February, 2023 12 hrs'
    },
    judging: ['The top 3 submissions with the highest score on the test dataset will be rewarded.','If there is a clash between any two submissions, the participant who submits first gets preference.','Decisions of the organizers will be final and binding.No claim will be entertained against the announced results.'],
    prizes: ['The top 3 teams will receive prizes of worth Rs.10,000 along with an E-certificate of Excellence','This prize money will be awarded via NEFT and will be processed within 30 working days.','The winner will be notified via email sent from(elan@iith.ac.in).','E - certificate of Participation will be given to all the participants'],
    contact: [{
      name: 'C Vishweshwar Reddy',
      contact: 9392615162
    }
      , {
        name: 'C V Jaya Karthik',
        contact: 6235006783
    },]
  },
  {
    ...
    format: [''],
    rules: ['This is an online event starting from 10/02/2023 (Saturday) and is a single stage event. This event lasts for a week and the winners are decided accordingly after the event.', 'Participants are required to submit a video (of max 5 min) explaining their proposed solution.', 'Participants are also required to submit a report which include Literature review, Different techniques used and the related codes, References', 'Participants can be of teams 3 - 5', 'The idea presented by the teams should be original or open-source'],
    timeline: {
      regstart: '13th Jan 2023',
      regend: '8th Feb 2023',
      event: '10th Feb 2023'
    },
    judging: ['The submissions will be scored based on the novelty and appropriateness of the solution', 'The final score would comprise of 50% Presentation Video, 50% Report'],
    prizes: ['The top two participants will receive prizes of worth Rs.10,000.', 'This prize money will be awarded via NEFT and will be processed within 30 working days.', 'The winner will be notified via email sent from(elan@iith.ac.in).', 'E - certificate of Excellence will be given to the top 2 participants.'],
    contact: [{
      name: 'Srikar Arugonda',
      contact: 8688932454
    },
    {
      name: 'Ahmik Virani',
  ...
  },
  {
    ...
    prizes: ['The top two teams will receive prizes worth Rs. 10000.', 'This prize money will be awarded via NEFT and will be processed within 30 working days. ', 'The winner will be notified via email sent from(elan@iith.ac.in).', 'E - certificate of Participation will be given to all the participants who have submitted their model via the submission form', 'E - certificate of Excellence will be given to the top 2 teams.'],
    contact: [{
      name: 'Omkar Nilkanth',
      contact: 7058884881
    },
  ...
  
  {
    ...
    reglink: "https://unstop.com/competition/paper-presentation-elan-nvision-2023-indian-institute-of-technology-iit-hyderabad-588565",
    sublink: "",
    documentation:
      "https://docs.google.com/document/d/1EN1j2047opvegnPWvpc948hF6BheRCR77HRnf9lSbO8/edit",
    img: paperpe,
    details: "Elan & ηvision 2023, IIT Hyderabad proudly presents its exploration event \"Paper Presentation\".An out- and - out platform where students from all backgrounds manifest their research work by presenting their proficient papers related to various topics in the fields of science and engineering to ingenious judges.You are expected to send an abstract of your work(15 days prior) based on which you will be qualified to present your paper during ELAN & ηvision 2023.",
    format: [''],
    ...
    timeline: {
      regstart: '14th January 2023',
      regend: '3rd February 2023',
      event: 'Submission Deadline for Abstract -\t3rd February 2023\n\nAnnouncement of Round 2 Qualifiers -\t10th February 2023\n\nRound 2 -\t18th February 2023 (Tentative)\n\nWinners Announcement -\t19th February 2023 (Tentative)'
    },
    judging: ["Abstract:",'The abstract should be simple yet clear about your topic of research.', 'The topic on which the research is done should strive to make human life a better one.', 'If the topic about which the abstract is submitted is an extension to one of the works done earlier but a better version of that.The ways in which it is a better one should be mentioned.',"Round 2:", 'Correctness of facts.', 'Methods of analysis.', 'Innovativeness of idea.', 'Presentation of solutions or ideas.', 'Practical feasibility or implication of ideas.'],
    prizes: ['The top two teams will receive prizes worth Rs. 20,000.', 'This prize money will be awarded via NEFT and will be processed within 30 working days.', 'The winner will be notified via email sent from elan@iith.ac.in .', 'E - certificate of Participation will be given to all the participants who have submitted their model via the submission form', 'E - certificate of Excellence will be given to the top 2 teams.'],
    contact: [
      {
  ...
  },
  {
    ...
    img: game_jam,
    details: "Elan & ηvision 2023, IIT Hyderabad is organizing the Game Jam event.\nThe competition is not just to win by developing the game but instead to polish the skills of game development.Don’t miss this opportunity!",
    format: [''],
    rules: ['This event will be held in a single round.', 'It will be held in itch.io and the exact links are given at the start of the event.', ' This event starts on 17/02/2023 and lasts for 36 hours.', 'Participants should create a game in stipulated time.', 'All the assets can be used in developing the game (make sure you have the rights to use the assets).', 'Your game should be made within the stipulated time.', 'Relevance to the theme is preferred and has points if the theme is shown in game. (Note: This is not compulsory for the submission of the game however this is only preferred in the view of Game Jam).', 'Other Instructions are written on the Game Jam itch.io page.',],
    timeline: {
      regstart: '12th Feb 2023',
      regend: '16th Feb 2023',
      event: '17th - 18th Feb 2023'
    },
  ...
  {
    name: "Sugar Rocketry",
    details: "The word \"rocket\" can mean different things. Most people think of a tall, thin, round vehicle.They think of a rocket that launches into space. \"Rocket\" can mean a type of engine.The word also can mean a vehicle that uses that engine.A sugar rocket is a model rocket powered by a mixture of sugar and an oxidizer(commonly KNO3).The specific impulse, total impulse and the thrust are generally lower for the same amount of the fuel than other composite model rocket fuels, but sugar rockets are significantly cheaper",
    img: rocket,
    reglink: "https://unstop.com/competition/sugar-rocketry-elan-nvision-2023-indian-institute-of-technology-iit-hyderabad-588234",
    sublink: "",
    format: [],
    ...
    prizes: ['The top two participants will receive prizes of worth Rs. 24000.', 'This prize money will be awarded via NEFT and will be processed within 30 working days.', 'The winner will be notified via email sent from(elan@iith.ac.in).', 'E - certificate of Participation will be given to all the participants', 'E - certificate of Excellence will be given to the top 2 participants.'],
    contact: [
      {
  ...
  },
  {
    ...
    details: "Shooting Planets will be an astrophotography-oriented challenge wherein participants are required to perform elementary astronomical image processing.Raw video data will be provided to the participants from which a stacked image and a detailed report will have to be submitted.In case the participants want to collect their own data, our club telescope and planetary camera will be made available to them.",
    img: splanets,
    reglink: "https://unstop.com/p/shooting-planets-elan-nvision-2023-indian-institute-of-technology-iit-hyderabad-586819",
    sublink: "",
    documentation: "",
    format: [''],
    rules: ["The event is to be held in a single round.", "All participants are required to submit the report and image before the deadline mentioned in the timeline section.Failing to do so will result in non evaluation.", "The top two submissions will be awarded based on the judging criteria.", "Teams of maximum size 4 members are permitted.", "Any stacking / photoshop software can be used.", "All relevant software settings used must be mentioned in the report.", "The report must be submitted in Size 11, Calibri", "Add your personal details(names and roll numbers to the report that you submit.)", "The organisers’ decision will be final and binding.", "The participant has to upload their image on the submission form shared in the website.", "Specifications of the image are as follows:\n\tFormat: PNG\n\tResolution: 1280 * 720\n\tThe report is to be uploaded in pdf format in the same link."],
    prizes: ['The top two participants will receive prizes of worth Rs. 5000.', 'This prize money will be awarded via NEFT and will be processed within 30 working days.', 'The winner will be notified via email sent from(elan@iith.ac.in).', 'E - certificate of Participation will be given to all the participants', 'E - certificate of Excellence will be given to the top 2 participants.'],
    judging: ["The image will be judged based on its visual accuracy.", "If the astronomical object in question is difficult to locate / capture then this will also be considered as a deciding factor.", "The report will be judged based on how efficiently the software has been used for stacking."],
    contact: [
      {
        name:"V. Aashrita",
        contact: 7989621724
  ...
  },
  {
    ...
    judging: ['Upto the discretion of the judge'],
    contact: [{name: 'Devansh Jain', contact: 7339956844}, {name: 'Aryan Jain', contact: 9650896994}, {name: 'Vaishnavi Vyasraj', contact: 9148226200}],
    timeline: {
      regstart: '11th Jan 2023',
      regend: '16th Feb 2023',
      event: '19th Feb 2023'
  ...
  },
  {
    ...
    prizes: ['The top two participants will receive prizes of worth Rs. 27,000.', 'This prize money will be awarded via NEFT and will be processed within 30 working days.', 'The winner will be notified via email sent from(elan@iith.ac.in).', 'E - certificate of Participation will be given to all the participants', 'E - certificate of Excellence will be given to the top 2 participants.'],
    judging: ['Upto the discretion of the judge.'],
    contact: [{name: 'Swapnil Bag', contact: 8884581002}, {name: 'Divya Rajparia', contact: 8657434081}, {name: 'Harman Singh', contact: 9518076018}],
    timeline: {
      regstart: '11th Jan 2023',
      regend: '14th Feb 2023',
      event: '19th Feb 2023'
    },
  },
  {
    ...
    img: drift_king,
    reglink: "https://unstop.com/creative-cultural-event/drift-king-elan-nvision-2023-indian-institute-of-technology-iit-hyderabad-588643",
    sublink: "",
    documentation: "",
    format: [],
  ...
  },
  {
    ...
    img: robo_soccer,
    reglink: "https://unstop.com/competition/robo-soccer-elan-nvision-2023-indian-institute-of-technology-iit-hyderabad-587555",
    sublink: "",
    documentation: "",
    format: [],
