...
export const techydata = [
  ...
  },
  {
    ...
    prizes: ['The top 3 teams will receive prizes of worth Rs.10000 along with an E-certificate of Excellence','This prize money will be awarded via NEFT and will be processed within 30 working days.','The winner will be notified via email sent from(elan@iith.ac.in).','E - certificate of Participation will be given to all the participants'],
    contact: [{
  ...
  },
  {
    ...
    format: [''],
    rules: ['This is an online event starting from 26/03/2022 (Saturday) and is a single stage event. This event lasts for 12 hours and the winners are decided accordingly after the event.', 'Participants can participate in solo or team of 2. The event is held at AIcrowd and the registered participants receive the link for the event accordingly.', 'Participants are expected to crack the questions with some initial constraint provided over the dataset in the stipulated time', 'Participants should not take the help of the internet throughout this event. If done so, disqualification is taken with immediate effect.', 'Organizers of the event are in the state of decision in case of any discrepancies and their decision is the final and binding.'],
    timeline: {
      regstart: '',
      regend: '',
      event: ''
