...
export const techydata = [
  ...
  },
  {
    ...
    judging: ["The image will be judged based on its visual accuracy.", "If the astronomical object in question is difficult to locate / capture then this will also be considered as a deciding factor.", "The report will be judged based on how efficiently the software has been used for stacking."],
    judging: ['Round 1 (Offline)', 'Obstacle talking round. Each car will complete one single lap on the track containing obstacles one by one.', 'Round 2 (Offline)', 'Qualifying team would be jumping off the ramp, and the winner would be decided based on jump distance from the ramp.'],
    contact: [{
