...
export const cultidata = [
  ...
  },
  {
    ...
    rules: ['This is an offline solo singing competition.', 'Registration can be online or on - spot during Elan & ηvision 2023.', 'This competition consists of 2 rounds - Prelims and the Finals.', 'At most 10 participants would be selected for the finals depending on the prelims performance, and the number of participants.', 'Participants can sing any song of his/ her choice of genre in Hindi, English or Telugu.', 'Prelims Round: To participate in Campus Idol, you must have five songs you know very well and be ready to perform any of those five songs for the competition.If someone else has chosen your song, or something does not work out with your first choice, you will need to be ready to sing your other choice.', '  Finals: For finals, a participant can sing any Hindi, English or Telugu song of his / her own choice.', '    On - Spot Registration closes one hour before the start of the event.', 'Songs containing vulgar or explicit lyrics will not be allowed. Contestants who, during their performance, use vulgar lyrics or perform in an obscene manner will be disqualified from the competition, NO RAP.', 'Participants can bring a karaoke track or play an accompanying instrument and are also allowed to have an instrumentalist accompanist(max 2) ONLY for the final round and not for the prelims.', 'For prelims, the round time limit is 2 minutes, and for finals, there is a 3-minute time limit(multiple songs can be sung in any round).The participants should perform for a minimum of 90 seconds(including Mukhda and Antara).', 'No backing vocals are allowed. ', 'Participants exceeding the prescribed time limit will invite a penalty.', 'The decisions made by the organizers and the judges will be final and abiding.', 'The organizing team has the complete right to change the prize money if the participation is less than five.','The event will be held at the Amphitheatre in IIT Hyderabad.'],
  ...
  },
{
  ...
  },
  {
    ...
    timeline: { poster: '21st March 2022, 11:59pm', event:  '26th March 2022' },
  ...
  },
  {
    ...
    timeline: { poster: 'March 22nd, 2022, 11:59pm', event: '26th March, 2022' },
  ...
  },
  {
    ...
    timeline: { poster: '13th January, 2023', event:'26th March, 2022' },
